...
<head>
    ...
    <title>Accesorios Deportivos - Tienda Deportes</title>
...
<body class="categoria-page font-inter antialiased">
    <!-- Header -->
    <header class="bg-white shadow-md py-4 px-6 md:px-12 flex justify-between items-center rounded-b-xl">
        ...
        <nav class="hidden md:flex space-x-8">
            ...
            <a href="indexAccesorios.php" class="text-primary font-semibold transition-colors duration-300">Accesorios</a>
    ...
    <nav id="mobile-menu" class="hidden md:hidden bg-white shadow-lg py-4 rounded-b-xl mx-4">
        <ul class="flex flex-col items-center space-y-4">
            ...
            <li><a href="indexProductos.php" class="block text-dark transition-colors duration-300 text-lg">Todos</a></li>
            ...
            <li><a href="indexAccesorios.php" class="block text-primary font-semibold hover:text-primary transition-colors duration-300 font-medium text-lg">Accesorios</a></li>
    ...
    <div class="container">
        <div class="page-title">
            <h1><i class="fas fa-boxes"></i>Accesorios Deportivos</h1>
            <p>Complementa tu entrenamiento con los mejores accesorios deportivos. Todo lo que necesitas para mejorar tu rendimiento.</p>
        </div>

        
        <div class="filters-container mb-6" style="display: none;">
            <div class="flex flex-wrap justify-center gap-2">
                <button onclick="filterByCategory('all')" class="filter-btn">Todos</button>
                ...
                <button onclick="filterByCategory('3')" class="filter-btn active">Accesorios</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🚀 Inicializando página de ACCESORIOS...');
            
            setTimeout(() => {
                if (typeof productos !== 'undefined') {
                    productos.cargarAccesorios(); // Categoría 3
                } else {
