...
<head>
    ...
    <title>Calzado Deportivo - Tienda Deportes</title>
...
<body class="categoria-page font-inter antialiased">
    ...
    <header class="bg-white shadow-md py-4 px-6 md:px-12 flex justify-between items-center rounded-b-xl">
        ...
        <nav class="hidden md:flex space-x-8">
            ...
            <a href="indexCalzado.php" class="text-primary font-semibold transition-colors duration-300">Calzado</a>
...
<!-- Iconos de Usuario y Carrito -->
    ...
    <nav id="mobile-menu" class="hidden md:hidden bg-white shadow-lg py-4 rounded-b-xl mx-4">
        <ul class="flex flex-col items-center space-y-4">
            ...
            <li><a href="indexProductos.php" class="block text-dark font-semibold transition-colors duration-300 text-lg">Todos</a></li>
            ...
            <li><a href="indexCalzado.php" class="block text-primary font-semibold hover:text-primary transition-colors duration-300 font-medium text-lg">Calzado</a></li>
    ...
    <div class="container">
        <div class="page-title">
            <h1><i class="fas fa-boxes"></i>Calzado Deportivo</h1>
            <p>Encuentra el mejor calzado deportivo para tu entrenamiento. Comodidad, estilo y rendimiento en cada paso.</p>
        </div>
        ...
        <div class="filters-container mb-6" style="display: none;">
            <div class="flex flex-wrap justify-center gap-2">
                ...
                <button onclick="filterByCategory('2')" class="filter-btn active">Calzado</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🚀 Inicializando página de CALZADO...');
            
            setTimeout(() => {
                if (typeof productos !== 'undefined') {
                    productos.cargarCalzado(); // Categoría 2
                } else {
