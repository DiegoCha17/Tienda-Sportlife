...
<head>
    ...
    <title>Equipos de Gym - Tienda Deportes</title>
...
<body class="categoria-page font-inter antialiased">
    ...
    <header class="bg-white shadow-md py-4 px-6 md:px-12 flex justify-between items-center rounded-b-xl">
        ...
        <nav class="hidden md:flex space-x-8">
            ...
            <a href="indexGym.php" class="text-primary font-semibold transition-colors duration-300">Gym</a>
    ...
    <nav id="mobile-menu" class="hidden md:hidden bg-white shadow-lg py-4 rounded-b-xl mx-4">
        <ul class="flex flex-col items-center space-y-4">
            ...
            <li><a href="indexGym.php" class="block text-primary font-semibold hover:text-primary transition-colors duration-300 font-medium text-lg">Gym</a></li>
    ...
    <div class="container">
        <div class="page-title">
            <h1><i class="fas fa-boxes"></i>Equipos de Gym</h1>
            <p>Transforma tu entrenamiento con nuestro equipo de gimnasio profesional. Calidad y resistencia para todos los niveles.</p>
        </div>
        ...
        <div class="filters-container mb-6" style="display: none;">
            <div class="flex flex-wrap justify-center gap-2">
                ...
                <button onclick="filterByCategory('5')" class="filter-btn active">Gym</button>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🚀 Inicializando página de GYM...');
            
            setTimeout(() => {
                if (typeof productos !== 'undefined') {
                    productos.cargarGym(); // Categoría 5
                } else {
