...
<head>
    ...
    <title>Ropa Deportiva - Tienda Deportes</title>
...
<body class="categoria-page font-inter antialiased">
    ...
    <header class="bg-white shadow-md py-4 px-6 md:px-12 flex justify-between items-center rounded-b-xl">
        ...
        <nav class="hidden md:flex space-x-8">
            ...
            <a href="indexRopa.php" class="text-primary font-semibold transition-colors duration-300">Ropa</a>
...
<!-- Iconos de Usuario y Carrito -->
    ...
    <nav id="mobile-menu" class="hidden md:hidden bg-white shadow-lg py-4 rounded-b-xl mx-4">
        <ul class="flex flex-col items-center space-y-4">
            ...
            <li><a href="indexRopa.php" class="block text-primary font-semibold hover:text-primary transition-colors duration-300 font-medium text-lg">Ropa</a></li>
    ...
    <div class="container">
        <div class="page-title">
            <h1><i class="fas fa-boxes"></i>Ropa Deportiva</h1>
            <p>Descubre nuestra colección de ropa deportiva de alta calidad. Diseñada para el máximo rendimiento y comodidad.</p>
        </div>
        ...
        <div class="filters-container mb-6" style="display: none;">
            <div class="flex flex-wrap justify-center gap-2">
                ...
                <button onclick="filterByCategory('1')" class="filter-btn active">Ropa</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🚀 Inicializando página de ROPA...');
            
            setTimeout(() => {
                if (typeof productos !== 'undefined') {
                    productos.cargarRopa(); // Categoría 1
                } else {
