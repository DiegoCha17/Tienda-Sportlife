...
<head>
    ...
    <title>Suplementos Deportivos - Tienda Deportes</title>
...
<body class="productos-page font-inter antialiased">
    ...
    <header class="bg-white shadow-md py-4 px-6 md:px-12 flex justify-between items-center rounded-b-xl">
        ...
        <nav class="hidden md:flex space-x-8">
            ...
            <a href="indexSuplementos.php" class="text-primary font-semibold transition-colors duration-300">Suplementos</a>
        </nav>
    ...
    <nav id="mobile-menu" class="hidden md:hidden bg-white shadow-lg py-4 rounded-b-xl mx-4">
        <ul class="flex flex-col items-center space-y-4">
            ...
            <li><a href="indexSuplementos.php" class="block text-primary font-semibold hover:text-primary transition-colors duration-300 font-medium text-lg">Suplementos</a></li>
        </ul>
    </nav>
    ...
    <div class="container">
        <div class="page-title">
            <h1><i class="fas fa-boxes"></i>Suplementos Deportivos</h1>
            <p>Potencia tu rendimiento con nuestra línea de suplementos deportivos de alta calidad. Nutrición especializada para atletas.</p>
        </div>
        ...
        <div class="filters-container mb-6" style="display: none;">
            <div class="flex flex-wrap justify-center gap-2">
                ...
                <button onclick="filterByCategory('4')" class="filter-btn active">Suplementos</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🚀 Inicializando página de SUPLEMENTOS...');
            
            setTimeout(() => {
                if (typeof productos !== 'undefined') {
                    productos.cargarSuplementos(); // Categoría 4
                } else {
